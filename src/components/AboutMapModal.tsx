...
export default function AboutMapModal({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return (
    <SgdsModal ref={modalRef} className="about-map-modal" size="md" onSgdsClose={onClose}>
      ...
      <div className="sgds:flex sgds:flex-col sgds:gap-component-md">
        <section aria-labelledby="why-this-map">
          ...
          <div className="sgds:mt-text-xs sgds:flex sgds:flex-col sgds:gap-text-2-xs">
        ...
        <section aria-labelledby="about-me">
          ...
          <div className="sgds:mt-text-xs sgds:flex sgds:flex-col sgds:gap-text-2-xs">
            <p className="sgds:text-body-md sgds:font-regular sgds:leading-xs sgds:tracking-normal sgds:text-body-default">I’m Ernest, an Average Joe who enjoys building small things that make everyday information a little easier to understand. Outside of my computer, you can probably find me out for a run, volunteering, or chatting with people and hearing their stories.</p>
